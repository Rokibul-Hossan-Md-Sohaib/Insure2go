...
const Conditions = () => {
  return (
    <>
      <Navs />
      <Container>
        <h1 className="text-center mt-5 text-danger">Terms & Conditions </h1>
        <p className=" mt-4 text-secondary">
          Insure To Go can Assist You With Finding Quotations For Van Insurance,
          Fleet Insurance Including Courier Delivery Or Any Other Business Use.
          You Are Strongly Advised To Understand The Following Terms Below
        ...
        <div className="mt-3" style={{ margin: "20px" }}>
          <p style={{ margin: "20px", lineHeight: "2.3" }}>
            ...
            <br /> *	This website doesn't generate any quotes itself like other comparison sites as we are not authorised to do so and all access to use of this Website is subject to these terms and conditions (“Terms of Use”). By accessing and using this Website you agree to be bound by these Terms of Use. If you do not agree to these Terms of Use, you are not permitted to access and use this Website and you should immediately cease accessing and using this Website.
 <br /> *	If you breach any provision of these Terms of Use then your right to access and use this Website will immediately cease
<br /> *	Insure To Go does not give any advice or make any personal recommendations as to the suitability of any policy to individual or business client’s circumstances. We may describe policy features, but it is the client’s decision to buy.
<br /> *	Insure To Go is an independent price searching company (not associated with any insurer or underwriter), a 3rd Party who works on customer’s behalf only up to searching the quotations.

            <br />
           
            <h6 className="mt-3" >  2. Privacy Policy</h6>
            ...
            * We acknowledge and agree to be bound by the terms of our Privacy
            ...
            you.
            <br />
            <h6 className="mt-3">3. General</h6>
  
Insure To Go does not intend to carry out any regulated activities therefore, we DO NOT Regulate, Monitor, Forward, Administrate or set up any policies. We may read or describe all the quotes to you and the features and benefits, but it is solely your (clients) task to buy or go ahead with the rest on your own.
<br /> 3 .1 If any provision of these terms and conditions are held by any competent authority to be invalid or unenforceable in whole or in part, the validity of the other provisions of this agreement and the remainder of the provision in question will not be affected. English law will apply to this agreement and the parties agree to submit to the non-exclusive jurisdiction of the English courts. Save as expressly provided elsewhere these terms and conditions shall apply only between us and you and no other person shall be entitled to benefit from them
<br /> 3.2 In terms of Searching quotes our activities DO NOT include the following- (Under Section 19, FSMA Act 2000, Order 2001(RAO) - FCA Handbook
<br />	A) Accepting deposits or arranging cover
<br />	Under Section 19 of FSMA provides that a person may not carry on a regulated activity in the UK unless he is authorised or exempt. The ''Regulated Activities'' are specified in the FSMA Act 2000, Order 2001(RAO) - FCA Handbook
<br />A) Effecting or carrying out contracts of insurance as principal.
<br />	C) Assisting in the administration and performance of a contract of insurance.


<h6 className="mt-3">4. PCI DSS Compliance Information</h6>
In terms of handling personal and sensitive data and payment information we are registered with ICO as per Data Protection Act 2018 & GDPR compliant and made our declarations to the information commissioner. As a merchant we provide information to Squareup International Limited to be compliant with (PCI DSS) Payment Card Industry Data Security Standards.
...
<br /> *  All product prices are quoted in UK pounds(£).
<br /> *  We are not responsible or liable for any loss or damage you or any third party may suffer or incur in connection with any product you obtain after using this Website or for any acts, omissions, errors or defaults of any third party in connection with that product.
...
7. Insure To Go service and how we are paid
<br /> *  Your responsibility to provide accurate details and if your insurer provides any unfair terms the following terms and conditions are applicable for all customers (specially who consumes Quote service): if you agree with insurer’s/broker’s terms and conditions as stated on their website. You pay  Insure To Go a separate service fee for price searching work. If the insurer accepts the payment from your bank card, this fee is non-refundable. We do not take any commission from the insurer and our services are limited to price searching. If the payment does not go through due to incorrect or false information provided to us by you, such as but not limited to undeclared accidents, penalties & NCB, we reserve the right to charge for our service from the amount that you would pay to Insure To Go, even if we do not manage to find you quotes with the correct information given to us afterwards. If any similar quotation that is generated through our work is bought, the charges for our work may apply depending on circumstances. If the insurer imposes any unfair terms to cancel your policy, depending on the time of cover we may deduct only £50 of the service charge you have paid us and refund you the rest although according to our full terms we are not obliged to do this. Insure To Go is a service providing company, not the insurer or broker. In terms of legality and data accuracy any information entered on the insurer’s website has been recorded and insurer/broker sends you this via email link or post. It is your responsibility to check your policy documents, statement of facts and staying updated with your Insurer requirements from time to time. As an independent price searching company we do not monitor or administrate any policy
<br /> *   We do not conduct activities as a broker or agent for any specific company. Coherence to Consumer Rights Act 2015 and The General Data Protection Regulation (GDPR) . The client (yourself) is appointing or authorising us to carry out price searching work on your behalf to find you quotation or renewal comparison from the available market (based on the accuracy of the information you have submitted to us). Insure To Go does not make any personal recommendations or suggestions or give any financial advice to the suitability of any products to our clients (yourself) as we are not FCA regulated.
<br /> *  Some of the insurers do not like 3rd party involvement in quotation searching on customer’s behalf. However, if your policy gets cancelled anytime within 3 months of receiving the quotations links from us we may search for you again for free or we will issue full refund of our service charge if any occurrence or mistakes made by us during the searching process (subject to mutual convenience and reliable fact). After receiving quotations links in the email, if you find any details incorrect or inappropriate please amend it with the insurer immediately before going ahead further and if premium increases due to that amendment, we will adjust the difference with our service charge or search for you again with free of charge (Subject to price comparison sites algorithm).




<h6 className="mt-3">8. Motor Insuring Database</h6>
...
<h6 className="mt-3">11. Governing law</h6>
<br /> *  These Terms of Use and your access to and use of this Website is governed by and will be interpreted in accordance with the laws of the UK.
<br /> *   Each of you and us submits to the non-exclusive jurisdiction of the courts of the UK in connection with these Terms of Use and your access to and use of this Website
